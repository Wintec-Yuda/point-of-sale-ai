...
const navItems = [
  { name: 'Dashboard', path: '/cashier', icon: <FiHome /> },
]
      ...
      <aside className="hidden lg:block fixed inset-y-0 left-0 z-40 w-64 bg-white border-r border-gray-200">
        <div className="flex flex-col h-full p-4">
          <div className="flex items-center justify-center h-16 mb-8">
            <h1 className="text-xl font-bold text-indigo-600">Cashier POS</h1>
          </div>
            ...
            >
              <div className="flex flex-col h-full p-4">
                ...
                <div className="mt-auto mb-4">
                  <Link href="/" className="flex items-center p-3 w-full rounded-lg text-gray-600 hover:bg-gray-100">
                    <FiLogOut className="mr-3" />
                    <span className="font-medium">Logout</span>
                  </Link>
                </div>
